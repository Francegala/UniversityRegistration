...
public class UndergraduateStudent extends AbstractStudent {
	...
	private UndergraduateStudent(StudentName studentName, Calendar studentbDate, Date dbirthDate, int numberOfModules, String stage, StudentID studentStudentID) throws IOException, MyException {
