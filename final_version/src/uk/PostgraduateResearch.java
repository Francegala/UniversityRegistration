...
public final class PostgraduateResearch implements Student{
	...
	public Modules getModule() throws MyException {
	...
	public String getPassmark() throws MyException {
		throw new MyException("Postgraduate research student doesn't have modules and percentage");
