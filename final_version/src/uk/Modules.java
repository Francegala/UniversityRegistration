...
public class Modules {
	...
	public Modules(int a, String stage ) throws IOException, MyException {
	...
	private static int valueOf(String s) throws MyException{ 
	...
	private static List readModuleFile(int stage) throws IOException {
